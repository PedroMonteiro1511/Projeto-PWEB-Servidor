<form action="index.php?c=iva&a=store" method="post">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" name="percentagem" id="percentagem" maxlength="10"
            placeholder="Inserir Percentagem" value="<?php if (isset($model)) {
    ...
    <div class="form-group mt-4">
        ...
        <input type="text" class="form-control" name="descricao" id="descricao" placeholder="Inserir Descrição" value="<?php if (isset($model)) {
    ...
    <p class="mt-4">
        ...
        <a href="index.php?c=iva&a=index" class="btn btn-secondary" role="button" aria-pressed="true">Voltar</a>
    </p>
</form>