...
<form action="index.php?c=user&a=store" method="post">
    ...
    <div class="form-group">
        ...
        <input value="<?php if (isset($model)) {
            echo $model->telefone;
        } ?>" type="tel" id="telefone" name="telefone" placeholder="Numero de Telefone" required>
        <p style="color: red"><?php
            if (isset($model->errors)) {
    ...
    <div class="form-group">
        ...
        <input value="<?php if (isset($model)) {
            echo $model->nif;
        } ?>" type="text" id="nif" name="nif" placeholder="Numero NIF" required>
        <p style="color: red"><?php
            if (isset($model->errors)) {
    ...
    <div class="form-group">
        ...
        <select class="form-control" name="role" id="role">
            <option selected value="<?= User::$Role_User_Cliente ?>"><?= User::$Role_User_Cliente ?></option>
